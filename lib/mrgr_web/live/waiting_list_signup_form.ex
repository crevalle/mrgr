        ...
        <.form let={f} for={:user} phx-submit="submit" class="sm:mx-aut- sm:max-w-xl lg:mx-0">
          <div class="sm:flex">
            ...
            <div class="mt-3 sm:mt-0 sm:ml-3">
              <button type="submit" class="block w-full rounded-md bg-gradient-to-r from-cyan-600 to-mrgr py-3 px-4 font-medium text-white shadow hover:from-teal-600 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-gray-900">Join the waiting list</button>
            </div>
          </div>
        </.form>
